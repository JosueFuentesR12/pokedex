        ...
        <div>
            ...
            <div>
                <Grid container rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 3 }}>
                    ...
                    <Grid item xs={columnSize}>
                        <Button variant="outlined" className="Button v2" onClick={clearBusqueda}>Borrar</Button>
                    </Grid>
                    <Grid item xs={columnSize}>
                        <Button variant="outlined" className="Button v2" onClick={handleSearchPokemon}>Buscar</Button>
                    </Grid>
                </Grid>
            </div>
        </div>
